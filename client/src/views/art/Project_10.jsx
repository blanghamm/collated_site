...
const Project_4 = () => {
  ...
  const draw = (p) => {
    ...
    p.strokeWeight(1.5);
    p.noFill();
    for (let i = 0; i < numberOf / stepNum / radius; i++) {
      p.line(
        radius * x1 + i / stepNum,
        sc.x2((info().value5 / stepNum) * x1 + i / radius),
        sc.x2((info().value5 / stepNum) * x1 + i / radius),
        radius * x1 + i / stepNum
      );
      // p.rotate(angle);
            ...
            <div class="overlay-ui">
              <div class="title-content">
                ...
                <p class="info-section">
                  Project ten pulls away from the previous iterations, opting
                  for slow falling line-based output. It also conforms to a
                  triangle-esque boundary, making the entire piece feel
                  off-axis.
                </p>
              </div>
